...
const passion_p_text = new Array(
  "It was a Saturday afternoon of April of 2015. After taking lunch, I was watching a movie at the TV room with my mom. The clock had read 11:55 AM when it started. The ground surface jolted strongly and in no time, I was getting a see-saw experience; it was an earthquake. My mom was quick to react as she promptly moved me and herself under a door. Every second then was a nightmare: the bookshelves of my room crashed and from the window, I saw the nearby buildings literally colliding with each other. The background noise of screaming people and barking dogs amplified the trepidation of the people. The havoc continued for a total of 55 seconds when the vibrations finally stopped.",
...
const activism_p_text = new Array(
  ...
  "The next morning, my eyes opened by the ring of alarm. It was 5:00 AM—very cold outside. Snoozing the alarm, I stuffed myself inside the blanket. “I’ll wake at time from tomorrow.” The promise of the previous day appeared in my memories. Every second after this, my heart exhorted me to wake up. Impulsively, I came out of the blanket and brushed my teeth before the alarm rang again. After exercising for 30 minutes, I went for running exactly on time. That morning, I hit 5 kilometers in 23 minutes. The running pace didn’t bother me because I had completed my daily running quota.",
